...
/*/{Protheus.doc} User Function RFONI02
...
User Function RFONI02()
	...
	If ParamBox(aPergs,"Caminho",@aRet,,,,,,,"",.T.,.T.)
		...
		If MessageBox("Deseja realizar a importação do Pedido de Vendas?","TOTVS",4) ==  6
			...
			FWMsgRun(,{|| ImportPC(aRet[1])}, "Aguarde...", "Processando Registros...",.F.)
...
Static Function ImportPC(cFile)
	...
	If lMsErroAuto
		cErro := "Atenção: Pedido não foi importado. Ao tentar realizar a importação, o Protheus retornou o seguinte erro:"
		cErro += Chr(13) + Chr(10)
		cErro += Chr(13) + Chr(10)
