...
Module   : Financeiro
Source   : WFON004
Objective: Relatório de Lembrete de Vencimento (transferência)
*///#########################################################################################
...
User Function WFON004C()
	...
	WHILE !T01->(EOF())
		...
		cQuery += " E1_VENCREA IN ("+cLemQry+") AND E1_SALDO>0 AND E1_NATUREZ='101002' AND "
		...
		If Len(aItens) > 0
			...
			cBody += "<br>"
			cBody += "<br>Estou entrando em contato para lembrá-lo(a) que o vencimento da sua nota fiscal está chegando."
			cBody += "<br>"
			cBody += cBodyt
            cBody += "<br>"
