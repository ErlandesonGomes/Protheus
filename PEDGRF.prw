...
Private	oBrush		:= TBrush():New(,4),;
		...
		While 	TRA->( ! Eof() )
				...
				If	( lFlag )
					...
					oPrint:Say(0570,1960,OemToAnsi('Numero documento'),oFont10n)
...
oPrint:Say(2790,0100,'NOTA: So aceitaremos a mercadoria se na sua Nota Fiscal constar o numero do nosso Pedido de Compras.' ,oFont12n)
oPrint:Say(2830,0100,'Entrega de materiais de Segunda-feira á Sexta-feira no horário de 09:00 horas ás 11:00 horas.',oFont12n)
oPrint:Say(2870,0100,'Destacar na NF o número do Pedido de Compra.',oFont12n)
oPrint:Say(2910,0100,'Notas fiscais de serviço deverão ser emitidas no máximo até dia 25 dentro do mês de sua competência.',oFont12n)
...
mCorpo += 'FONNET COMERCIO DE EQUIPAMENTOS DE TELECOMUNICACOES LTDA'+Chr(13)+Chr(10)
mCorpo += 'Fone: '+ GETMV("MV_YPCContato1") +Chr(13)+Chr(10)
mCorpo += 'Fone: '+ GETMV("MV_YPCContato2") +Chr(13)+Chr(10)
mCorpo += 'Site: www.fonnet.com.br'+Chr(13)+Chr(10)
